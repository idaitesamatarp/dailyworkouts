...
public class SelasaKardio extends AppCompatActivity {

    ListView list;
    String[] titles = {"Push Up 15x", "Sit Up 15x", "Plank 7 menit",
            "Leg Raise 7 menit", "Crunch Perut 15x",
            "Arm Raises 15x", "Mountain Climbers 15x",
            "Duduk di Dinding 7 menit", "Scissors 15x", "Tip Toe Squats 15x"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selasa_kardio);
